...
FROM table_1 
WHERE posn = 1 AND (constituency BETWEEN 'S14000021' AND 'S14000026')

#Alternative Solution

SELECT constituency, party FROM (SELECT constituency, party, votes, RANK() OVER (PARTITION BY constituency ORDER BY votes DESC) as posn
FROM ge
